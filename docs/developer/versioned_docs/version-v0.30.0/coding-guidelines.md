...
> **Note:** For complete coding standards, see [`AGENTS.md`](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.30.0/AGENTS.md).
...
See [`AGENTS.md`](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.30.0/AGENTS.md) for complete list of classes needing rename.
...
See [`AGENTS.md`](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.30.0/AGENTS.md) for complete guidelines.
