...
> **Note:** This guide is under construction. For now, please refer to [`AGENTS.md`](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.28.0/AGENTS.md) for detailed setup information.
...
See [`AGENTS.md`](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.28.0/AGENTS.md) for detailed patterns and conventions.
