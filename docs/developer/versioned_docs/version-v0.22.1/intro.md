...
See [CONTRIBUTING.md](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.22.1/CONTRIBUTING.md) for detailed contribution guidelines, code of conduct, and pull request process.

## 📄 License

This project is licensed under the [MIT License](https://github.com/jpawlowski/hass.tibber_prices/blob/v0.22.1/LICENSE).
