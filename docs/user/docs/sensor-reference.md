...
| <span id="ref-entry_mode" class="entity-anchor"></span>`entry_mode` | Data Mode | Datenmodus | Datamodus | Gegevensmodus | Dataläge | ❌ |
| <span id="ref-headless_mode" class="entity-anchor"></span>`headless_mode` | Headless Mode | Headless-Modus | Hodeløs modus | Headless-modus | Headless-läge | ❌ |
...
| <span id="ref-time_travel_days_offset" class="entity-anchor"></span>`time_travel_days_offset` | Time-travel Days Offset | Zeitreise-Versatz in Tagen | Tidsreiseforskyvning i dager | Tijdreisverschuiving in dagen | Tidsreseförskjutning i dagar | ❌ |
| <span id="ref-time_travel_reference_time" class="entity-anchor"></span>`time_travel_reference_time` | Shown Time | Angezeigte Zeit | Vist tidspunkt | Getoonde tijd | Visad tid | ❌ |
| <span id="ref-time_travel_time_offset" class="entity-anchor"></span>`time_travel_time_offset` | Time-travel Time Offset | Zeitreise-Uhrzeitversatz | Tidsreise-klokkeforskyvning | Tijdreis-tijdverschuiving | Tidsresa-klockförskjutning | ❌ |
| <span id="ref-time_travel_years_offset" class="entity-anchor"></span>`time_travel_years_offset` | Time-travel Years Offset | Zeitreise-Versatz in Jahren | Tidsreiseforskyvning i år | Tijdreisverschuiving in jaren | Tidsreseförskjutning i år | ❌ |
## Binary Sensors
